...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 contenu">
            ...
            <p>Le <b>Robot Go-West</b> a été commencé l'année dernière par un groupe d'élèves de l'ENSC. Cette section retrace la synthèse de ce qui avait été fait. Pour rappel, les principaux objectifs du projet général sont les suivants :
            <br><br>
            <div class="text-center">
            <img class="illustration" src="images/ecran-acueil.png" alt="ecran-accueil" height="600" width="1000"  >
            </div>
            </p><p class="centre"><u>Schéma illustrant les deux parties de l'objectif</u></p>
            Sur ce schéma, nous pouvons observer les deux différentes chaînes que nous devons réaliser. Commençons tout d’abord par un aperçu plus détaillé de ces deux chaînes :
            <h4>La chaîne Signal</h4>
            La partie signal est commune pour le projet Go-West et pour le projet nous permettant de transformer les signaux des plantes en son. Cette chaîne se décompose de la façon suivante :
            Tout d’abord nous avons les plantes, munies de capteurs directement reliés à notre CAN (convertisseur analogique vers numérique) VegetalSignals, ensuite nous avons l’opto-coupleur, qui permet de séparer les signaux de l’ordinateur de ceux des plantes, afin donc d’isoler les informations en provenance des plantes et de ne pas avoir d’informations parasites. Enfin l’opto-coupleur est relié à notre raspberry-pi pour entrer dans la deuxième chaîne. Nous avons donc pour l’instant le travail des années précédentes à savoir l’opto-coupleur muni de son programme de traitement de signal, ainsi qu’un deuxième programme nous permettant de convertir les informations obtenues en décimal. Durant cette année, nous n’avons pas continué à travailler sur la chaîne signal pour le robot Go-West.
            <h4>La chaîne Assemblage mécanique</h4>
            En ce qui concerne la partie assemblage mécanique, ce ne sont pas les élèves de l’année précédente mais directement notre superviseur et client, Pierre Grangé-Praderas, qui s’est occupé de nous fournir le matériel nécessaire pour ce projet.
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 contenu">
            ...
            <p>
            Le tuteur du projet, Pierre, a assemblé la caisse du robot en assemblant des plaques de bois découpées préalablement à la découpe laser.
           <br> Au niveau <b> mécanique, </b> l'ancien groupe a réalisé principalement :
            ...
            </p><p class="centre"><u> Ancienne chenille du robot Go-West</u></p>
            Cette ancienne chenille était constitué d'un plastique rigide, obtenu grâce à l'imprimante 3D. Nous avons fait le choix de choisir une chenille plus souple.
            <br><br>
            <div class="text-center">
            <img class="illustration" src="images/oscilloscope.png" height="400" width="500" >
            </div>
            <p class="centre"><u>Tests à l'oscilloscope</u></p>
            Des branchements avaient été fait pour la commande moteur.
            ...
            Manipulation effectuée sur un seul moteur. Nous avons pu cette année travailler sur deux moteurs.
            ...
            Code python crée afin de faire tourner les moteurs en boucle à différentes vitesse grâce à la librairie RPi.GPIO. Nous devions le modifier et le reprendre avec notre <a href="poleinformatique.php"><b>pole informatique</b></a>.
