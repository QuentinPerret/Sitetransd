      ...
      <div class="container">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 contenu">
				<h3>Division en deux pôles</h3>
				<p>Parmi les 4 élèves ayant participé au projet, aucun n'a été désigné comme chef de projet. La répartition s'est davantage faite par pôles : </p>
				<ul>
					<li><b>Pôle informatique : </b>Clara Courtois & Quentin Perret</li>
					<li><b>Pôle mécanique : </b>Matéo Da Ponte & Vanessa Pellefigue</li>
				</ul>
				...
				<ul>
					...
					<li>Rédaction d’un cahier des charges en amont du projet, actualisé s’il y a des changements</li>
					<li>Tenue d’un carnet de bord → à chaque séance, résumé de ce qui a été fait pour permettre à notre maître d’ouvrage et nous-même de suivre l’avancée du projet</li>
					<li>Rédaction de « demandes » → nous rédigeons explicitement chaque problème rencontré à l’écrit afin que chacun puisse le comprendre et éventuellement apporter une solution</li>
